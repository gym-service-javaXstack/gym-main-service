...
ALTER SEQUENCE usr_seq RESTART WITH 54;
...
INSERT INTO training (id, training_name, training_type_id, training_date, training_duration, trainee_id, trainer_id) VALUES (2, 'Training 2', 1, '2022-01-02', 90, 2, 2);

ALTER SEQUENCE training_seq RESTART WITH 54;